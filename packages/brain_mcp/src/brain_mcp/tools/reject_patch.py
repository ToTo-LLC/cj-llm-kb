"""MCP transport shim for brain_reject_patch. Real handler in brain_core.tools.reject_patch."""
...
from brain_core.tools.reject_patch import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.reject_patch import handle as _core_handle
