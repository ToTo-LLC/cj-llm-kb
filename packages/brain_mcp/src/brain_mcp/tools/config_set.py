"""MCP transport shim for brain_config_set. Real handler in brain_core.tools.config_set."""
...
from brain_core.tools.config_set import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.config_set import handle as _core_handle
