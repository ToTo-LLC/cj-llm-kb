"""MCP transport shim for brain_recent_ingests.

Real handler in brain_core.tools.recent_ingests.
"""
...
from brain_core.tools.recent_ingests import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.recent_ingests import handle as _core_handle
