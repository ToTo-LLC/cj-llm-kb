"""MCP transport shim for brain_propose_note. Real handler in brain_core.tools.propose_note."""
...
from brain_core.tools.propose_note import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.propose_note import handle as _core_handle
