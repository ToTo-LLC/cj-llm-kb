"""MCP transport shim for brain_classify. Real handler in brain_core.tools.classify."""
...
from brain_core.tools.classify import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.classify import handle as _core_handle
