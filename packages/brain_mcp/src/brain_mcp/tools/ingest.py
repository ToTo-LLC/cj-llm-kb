"""MCP transport shim for brain_ingest. Real handler in brain_core.tools.ingest."""
...
from brain_core.tools.ingest import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.ingest import handle as _core_handle
