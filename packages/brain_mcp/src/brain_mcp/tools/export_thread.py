"""MCP transport shim for brain_export_thread. Real handler in brain_core.tools.export_thread."""
...
from brain_core.tools.export_thread import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.export_thread import handle as _core_handle
