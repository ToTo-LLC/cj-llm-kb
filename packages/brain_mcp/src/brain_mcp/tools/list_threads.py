"""MCP transport shim for brain_list_threads. Real handler in brain_core.tools.list_threads."""
...
from brain_core.tools.list_threads import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.list_threads import handle as _core_handle
