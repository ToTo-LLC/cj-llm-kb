"""MCP transport shim for brain_create_domain.

Real handler in brain_core.tools.create_domain.
"""
...
from brain_core.tools.create_domain import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.create_domain import handle as _core_handle
