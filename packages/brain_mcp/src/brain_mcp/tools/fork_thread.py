"""MCP transport shim for brain_fork_thread. Real handler in brain_core.tools.fork_thread."""
...
from brain_core.tools.fork_thread import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.fork_thread import handle as _core_handle
