"""MCP transport shim for brain_mcp_install.

Real handler in brain_core.tools.mcp_install.
"""
...
from brain_core.tools.mcp_install import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.mcp_install import handle as _core_handle
