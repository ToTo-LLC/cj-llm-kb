"""MCP transport shim for brain_list_pending_patches. Real handler in brain_core.tools.list_pending_patches."""
...
from brain_core.tools.list_pending_patches import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.list_pending_patches import handle as _core_handle
