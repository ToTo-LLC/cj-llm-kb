"""MCP transport shim for brain_undo_last. Real handler in brain_core.tools.undo_last."""
...
from brain_core.tools.undo_last import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.undo_last import handle as _core_handle
