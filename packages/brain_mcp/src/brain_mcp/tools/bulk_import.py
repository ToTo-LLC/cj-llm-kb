"""MCP transport shim for brain_bulk_import. Real handler in brain_core.tools.bulk_import."""
...
from brain_core.tools.bulk_import import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.bulk_import import handle as _core_handle
