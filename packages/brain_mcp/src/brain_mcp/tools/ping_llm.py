"""MCP transport shim for brain_ping_llm.

Real handler in brain_core.tools.ping_llm.
"""
...
from brain_core.tools.ping_llm import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.ping_llm import handle as _core_handle
