"""MCP transport shim for brain_lint. Real handler in brain_core.tools.lint."""
...
from brain_core.tools.lint import DESCRIPTION, INPUT_SCHEMA, NAME
from brain_core.tools.lint import handle as _core_handle
