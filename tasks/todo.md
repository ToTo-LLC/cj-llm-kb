...
|---|---|---|---|---|
| 01 | [Foundation](./plans/01-foundation.md) | 📝 Ready for execution | Tested `brain_core` library (config, vault, llm, cost) green on Mac + Windows CI | brain-core-engineer, brain-test-engineer |
